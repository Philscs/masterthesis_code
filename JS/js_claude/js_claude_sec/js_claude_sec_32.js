class FingerprintProtection {
    ...
    initializeCanvasProtection() {
        ...
        HTMLCanvasElement.prototype.toBlob = function(callback) {
            ...
            const noisyImageData = addNoise(imageData);
            context.putImageData(noisyImageData, 0, 0);
            return this.originalCanvas.toBlob.apply(this, arguments);
        };
    }
    ...
    initializeAudioProtection() {
        AudioContext.prototype.createAnalyser = function() {
            const analyser = this.originalAudio.createAnalyser.apply(this, arguments);
        ...
        AudioContext.prototype.createOscillator = function() {
            const oscillator = this.originalAudio.createOscillator.apply(this, arguments);
