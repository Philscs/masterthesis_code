class BrowserStorageManager {
    ...
    save(key, value, options = { expiry: null }) {
        ...
        this.storage.setItem(key, this.encrypt(JSON.stringify(data)));
    }
...
// Zugriffskontrolle festlegen
manager.setAccessControl('userSettings', ['read', 'write']);

// Daten speichern
manager.save('userSettings', { theme: 'dark', language: 'de' }, { expiry: 1000 * 60 * 60 }); // 1 Stunde
